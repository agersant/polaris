...
- `-w some/path/to/web/dir` lets you point to the directory to be served as the web interface. You can get a copy of the polaris-web client from an existing install or from the [polaris-web releases](https://github.com/agersant/polaris-web/releases).
